...
kbl(df_pl %>% select(-plasticity, -direction), longtable = TRUE, booktabs = TRUE) %>%
...
```{r moment_sum, eval = TRUE, echo = FALSE}
loadd(moment_summary)
df_moments = moment_summary

# kbl(df_moments, longtable = TRUE, booktabs = TRUE,
