...
```{r rda_result, eval = TRUE, echo = FALSE, fig.cap=""}
loadd(perm_warm)
loadd(perm_cool)
...
### New Figure 6
```{r variance-plot, eval = TRUE, echo = FALSE, fig.height = 10}
readd(variance_plot)
```

### New Figure 7
```{r skewness-plot, eval = TRUE, echo = FALSE, fig.height = 10}
readd(skewness_plot)
```

### New Figure 8
```{r kurtosid-plot, eval = TRUE, echo = FALSE, fig.height = 10}
readd(kurtosis_plot)
```
