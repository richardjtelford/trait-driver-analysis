...
```{r happymoment_plot, eval = TRUE, echo = FALSE, fig.cap="Mean and higher traits moments (variance, skewness and kurtosis) for dN15, leaf area and leaf thickness over time. Shwon are mean values for each time period and climate treatment with standard error."}
readd(happymoment_plot)
```
...
```{r col-ext-time-plot, eval = TRUE, echo = FALSE, fig.cap="Number of species colonizing and going extinct over time in each climate treatment."}
