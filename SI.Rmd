...
```{r hist-all-1, eval = TRUE, fig.height=7, fig.cap="Histogram for mean trait values over time."}
...
```{r hist-all-2, eval = TRUE, fig.height=7, fig.cap="Histogram for mean trait values over time."}
...
```{r hist-all-3, eval = TRUE, fig.height=7, fig.cap="Histogram for mean trait values over time."}
...
```{r full_happymoment_plot, fig.cap="Change in mean, variance, skewness, kurtosis and range for leaf area, thickness, phosphorus, and C and N isotopes in each treatment and over time. Shown are mean values for each time period and climate treatment with standard error."}
...
```{r nike_1, fig.cap="Skewness versus kurtosis for all traits in the control plots across the gradient."}
...
```{r nike_2, fig.cap="Skewness versus kurtosis for all traits and treatemnts across the gradient."}
