...
```{r half_happymoment_plot, eval = TRUE, echo = FALSE, fig.cap="Mean and higher traits moments (variance, skewness and kurtosis) for dN15, leaf area and leaf thickness over time. Shwon are mean values for each time period and climate treatment with standard error."}
...
```{r full_happymoment_plot, eval = TRUE, echo = FALSE, fig.cap="Mean and higher traits moments (variance, skewness and kurtosis) for dN15, leaf area and leaf thickness over time. Shwon are mean values for each time period and climate treatment with standard error."}
