...
tibble(Treatment = c("warming", "cooling"),
       Variance = c(perm_warm$Variance[1], perm_cool$Variance[1]),
       Fvalue = c(perm_warm$F[1], perm_cool$F[1]),
       Pvalue = c(perm_warm$`Pr(>F)`[1], perm_cool$`Pr(>F)`[1])) %>% 
...
### New Figure 6
```{r variance-plot, eval = TRUE, echo = FALSE, fig.cap="New Fig. 6: Test of convergence of trait variance to warming and cooling."}
readd(variance_plot)
```

### New Figure 7
```{r skewness-plot, eval = TRUE, echo = FALSE, fig.cap="New Fig. 7: Test of convergence of trait skewness to warming and cooling."}
readd(skewness_plot)
```

### New Figure 8
```{r kurtosid-plot, eval = TRUE, echo = FALSE, fig.cap="New Fig. 8: Test of convergence of trait kurtosis to warming and cooling."}
readd(kurtosis_plot)
```
