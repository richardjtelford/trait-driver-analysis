...
```{r rda_plot, eval = TRUE, echo = FALSE, out.width = '85%'}
#fig.cap="Testing for convergence in multivariate community (first column) or trait-space (second and third column) as a function of year since transplant. Results from  Principal Response Curve multivariate RDA analysis. "}
#readd(TraitRDA)
